'use strict'
const TODO_LIST = [
    {title: "Помыть кота", status: false}, {title: "Вытащить курицу из морозилки", status: true}];
...
function render(){
    ...
    for (let i = 0; i < TODO_LIST.length; i++){
        ...
        const todo = `<li class= "list-group-item bg-black text-white d-flex justify-content-between">
